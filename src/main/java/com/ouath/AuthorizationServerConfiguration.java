...
import com.core.security.GatewayAccessDeniedHandler;
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerSecurityConfigurer oauthServer) throws Exception {
        ...
        oauthServer.accessDeniedHandler(new GatewayAccessDeniedHandler())
        ...
        endpoints.exceptionTranslator(new WebResponseExceptionTranslator() {
            ...
            public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
                ...
                if (e.getCause() != null && e.getCause() instanceof GatewayException) {
                    exception = (GatewayException) e.getCause();
                } else {
                    exception = new GatewayAuthorizationException("认证失败", e);
                }
    ...
    private List<TokenGranter> getTokenGranters(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        tokenGranters.add(new CustomClientCredentialsTokenGranter(endpoints.getTokenServices(),
                endpoints.getClientDetailsService(), endpoints.getOAuth2RequestFactory(), oauthService));
        tokenGranters
