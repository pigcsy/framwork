package com.security.client.userSecurity;
...
public class SecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    @Autowired
    com.core.redis.RedisCacheManager cacheManager;
    ...
    public Collection<ConfigAttribute> getAllConfigAttributes() {
        ...
        for (Entry<RequestMatcher, Collection<ConfigAttribute>> entry : resourceMap.entrySet()) {
