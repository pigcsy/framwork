...
//		String publicKey="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDE/qLX5dNCDrWs3fpfuMryBQSskVzmhmLitT3RR/Bsk8R0reewaHZ3Xk/w0h8l9qJp7r+NFve3eLopDIf0q6Sz80hd1sjRrMvXGq/eehH8SzKIru1vZv5FIim5CORU5I784KPZHzFcWqvcOWCidnvuYIRKmR94Gy/fcjV1Ngw4gQIDAQAB";
//		String privateKey="";


//		String publicKey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCJnofEAu7Gt/qCjSnPN+k/Vsfal/7fQ1N024XVBLk6KGVqk4O63DGp9rrNT9YxxiDEfU7OV4wYjUAKzbRCWt8nsAqeWwk32ff046w6SkliZdtYB+hPajOf7AL50+o1v+jtmFHZEoYDmG4BktWfnlc6+DggeX7ZRj+GfnQaHAJcgwIDAQAB";
//		String privateKey = "";
        try {
//			String data = "eyJhbGciOiJSUzI1NiJ9.eyJzdWIiOiLnlKjmiLflkI3np7AiLCJpYXQiOjE0NzY3NzM1NDd9.txVlophXQ2pOlIwL7Lkp_JJSRpSGF-qRuqr4qhwOqOlayEF-ytUHiDuazvqK-cJd9rFo2xuczzjf72LmKeujMZOh4zXP42j1IlfVxA68uD8H8pX-ZAp90xlJZ3puCTHIvCPTjBZ-Gnen9Bh9kzZGjlNt2pIOetQix7275-c1lt8";
//			String encryptedData = encryptByPrivateKey(data, privateKey);
//			System.err.println(encryptedData);
//			System.err.println(new String(decryptByPublicKey(encryptedData, publicKey)));
//
...
//			System.err.println(decryptByPrivateKey(encryptedDatas, privateKey));
            Map<String, String> aa = getKeys();
            System.err.println(aa.get(PUBLIC_KEY));
            System.err.println(aa.get(PRIVATE_KEY));
//			String content="sellerId=5edcd0504e1811e6fda1579f3ebe8971&totalPrice=0.10&tradeNo=201610120854085518Z2&type=0";
//			String sign = rsaSign(content, privateKey,"utf-8");
//			System.err.println("");
//			System.err.println(rsaSignCheck(content, sign, publicKey,"utf-8"));
...
//			System.err.println(rsaSign("eyJhbGciOiJSUzI1NiJ9.eyJzdWIiOiLnlKjmiLflkI3np7AiLCJpYXQiOjE0NzY3NzM5NzB9", privateKey, "US-ASCII"));
//			System.err.println(rsaSignCheck(dataa, sign, publicKey, "utf-8")); 
        } catch (Exception e) {
    ...
    /**
     * 获取秘钥 getKeys:(这里用一句话描述这个方法的作用). <br/>
    ...
    public static HashMap<String, String> getKeys() {
        try {
            ...
            e.printStackTrace();
            throw new GatewayException("生成秘钥对失败");
        }
    }

    /**
     * 私钥解密 decryptByPrivateKey:(这里用一句话描述这个方法的作用). <br/>
     * TODO(这里描述这个方法适用条件 – 可选).<br/>
     * TODO(这里描述这个方法的执行流程 – 可选).<br/>
     * TODO(这里描述这个方法的使用方法 – 可选).<br/>
     * TODO(这里描述这个方法的注意事项 – 可选).<br/>
    ...
    public static String decryptByPrivateKey(String content, String privateKey, String charset) throws Exception {
        ...
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            throw new GatewayException("公钥解密失败", e);
        } finally {
    ...
    /**
     * 公钥解密 decryptByPublicKey:(这里用一句话描述这个方法的作用). <br/>
     * TODO(这里描述这个方法适用条件 – 可选).<br/>
     * TODO(这里描述这个方法的执行流程 – 可选).<br/>
     * TODO(这里描述这个方法的使用方法 – 可选).<br/>
     * TODO(这里描述这个方法的注意事项 – 可选).<br/>
    ...
    /**
     * 公钥加密 encryptByPublicKey:(这里用一句话描述这个方法的作用). <br/>
     * TODO(这里描述这个方法适用条件 – 可选).<br/>
     * TODO(这里描述这个方法的执行流程 – 可选).<br/>
     * TODO(这里描述这个方法的使用方法 – 可选).<br/>
     * TODO(这里描述这个方法的注意事项 – 可选).<br/>
    ...
    public static String encryptByPublicKey(String content, String publicKey, String charset) throws Exception {
        ...
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            throw new GatewayException("公钥加密失败", e);
        } finally {
    ...
    /**
     * 私钥加密 encryptByPrivateKey:(这里用一句话描述这个方法的作用). <br/>
     * TODO(这里描述这个方法适用条件 – 可选).<br/>
     * TODO(这里描述这个方法的执行流程 – 可选).<br/>
     * TODO(这里描述这个方法的使用方法 – 可选).<br/>
     * TODO(这里描述这个方法的注意事项 – 可选).<br/>
    ...
    public static String encryptByPrivateKey(String content, String privateKey, String charset) throws Exception {
        ...
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            throw new GatewayException("私钥加密失败", e);
        } finally {
    ...
    public static String rsaSign(String content, String privateKey, String charset) {
        try {
            ...
            throw new GatewayException("签名失败", e);
        }
    }

    /**
     * 签名验证
     * rsaSignCheck:(这里用一句话描述这个方法的作用). <br/>
     * TODO(这里描述这个方法适用条件 – 可选).<br/>
     * TODO(这里描述这个方法的执行流程 – 可选).<br/>
     * TODO(这里描述这个方法的使用方法 – 可选).<br/>
     * TODO(这里描述这个方法的注意事项 – 可选).<br/>
    ...
    public static boolean rsaSignCheck(String content, String sign, String publicKey, String charset) {
        try {
            ...
            throw new GatewayException("签名验证失败", e);
        }
    }
