...
import com.common.constant.state.IsMenu;
import com.config.properties.GatewayProperties;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        GatewayProperties gatewayProperties = SpringContextHolder.getBean(GatewayProperties.class);
        if (!gatewayProperties.getSwaggerOpen()) {
